...
##### find_users_by_username_and_password(username: str, password: str) -> list[Account]
...
##### find_users_by_username(username: str) -> list[Account]
...
##### find_cash_accounts_by_username(username: str) -> list[CashAccount]
...
##### get_from_account_actual_amount(account: str) -> float
...
##### find_credit_accounts_by_username(username: str) -> list[CreditAccount]
...
##### update_credit_account(cashAccountId: int, round: float)
...
##### find_transactions_by_cash_account_number(number: str) -> list[Transaction]
...
##### insert_new_activity(date, description: str, number: str, amount: float, available_balance: float)
...
## Service Best Practices (Intentionally Violated)
